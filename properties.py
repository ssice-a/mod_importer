...
def register_addon_properties():
    ...
    bpy.types.Scene.modimp_import_collection_name = bpy.props.StringProperty(
        name="Import Collection (Legacy)",
        default="",
        description="Internal compatibility field; UI uses Collection instead",
    )
    ...
    bpy.types.Scene.modimp_frame_analysis_summary = bpy.props.StringProperty(
        ...
        default="",
        description="Short summary generated by the FrameAnalysis stage scanner",
    )

    bpy.types.Scene.modimp_export_collection_name = bpy.props.StringProperty(
        name="Export Collection (Legacy)",
        default="",
        description="Internal compatibility field; UI uses Collection instead",
    )
    bpy.types.Scene.modimp_export_dir = bpy.props.StringProperty(
        ...
        subtype="DIR_PATH",
        description="Directory that will receive exported buffers and optional INI/HLSL assets",
    )
    bpy.types.Scene.modimp_export_mode = bpy.props.EnumProperty(
        name="Export Mode",
        items=(
            ("BUFFERS_ONLY", "Buffers Only", "Export only game buffer resources"),
            ("BUFFERS_AND_INI", "Buffers + INI", "Export buffers, INI, and profile HLSL assets"),
        ),
        default="BUFFERS_ONLY",
        description="Choose whether export should write only buffers or also generate INI/HLSL",
    )
